...
public class ICSSParser extends Parser {
	...
	public static final int
		...
		RULE_ifClause = 4, RULE_elseClause = 5, RULE_variableAssignment = 6, RULE_variableReference = 7, 
		RULE_expression = 8, RULE_boolLiteral = 9, RULE_colorLiteral = 10, RULE_percentageLiteral = 11, 
		RULE_pixelLiteral = 12, RULE_scalarLiteral = 13, RULE_literal = 14, RULE_idSelector = 15, 
		RULE_classSelector = 16, RULE_tagSelector = 17, RULE_selector = 18, RULE_body = 19;
	private static String[] makeRuleNames() {
		return new String[] {
			"stylesheet", "styleRule", "declaration", "propertyName", "ifClause", 
			"elseClause", "variableAssignment", "variableReference", "expression", 
			"boolLiteral", "colorLiteral", "percentageLiteral", "pixelLiteral", "scalarLiteral", 
			"literal", "idSelector", "classSelector", "tagSelector", "selector", 
			"body"
		};
	}
	...
	public final ClassSelectorContext classSelector() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_classSelector);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(129);
	...
	public final TagSelectorContext tagSelector() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_tagSelector);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(131);
